...
namespace Spring.Threading
{
	...
	public class FutureResult
	{
		...
		{
            private readonly ICallable function;
            private readonly FutureResult enclosingInstance;
            
            public AnonymousClassRunnable(ICallable function, FutureResult enclosingInstance)
			{
		...
		protected internal System.Object value_ = null;
		...
		protected internal System.Reflection.TargetInvocationException exception_ = null;
		...
		/// </returns>		
		public virtual IRunnable Setter(ICallable function)
		{
		...
		protected internal virtual System.Object DoGet()
		{
			if (exception_ != null)
			{
			    throw exception_;
		...
		/// 
		/// </exception>
		public virtual System.Object TimedGet(long msecs)
		{
			lock (this)
			{
	    ...
	    public virtual Exception Exception
	    {
            ...
            set
            {
                lock (this)
                {
                    exception_ = new System.Reflection.TargetInvocationException(value);
                    ready_ = true;
                    System.Threading.Monitor.PulseAll(this);
                }
            }
