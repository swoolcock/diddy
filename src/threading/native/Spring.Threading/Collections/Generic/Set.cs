...
namespace Spring.Collections.Generic {
    ...
    public abstract class Set<T> : ISet<T> {
        ...
        public virtual ISet<T> Union(ISet<T> setOne) {
            ISet<T> resultSet = (ISet<T>)Clone();
            if(setOne != null) {
        ...
        /// </returns>
        public static ISet<T> Union(ISet<T> setOne, ISet<T> anotherSet) {
            if(setOne == null && anotherSet == null) {
                return null;
            }
            if(setOne == null) {
                return (ISet<T>)anotherSet.Clone();
            }
            if(anotherSet == null) {
                return (ISet<T>)setOne.Clone();
            }
        ...
        /// <see langword="null"/> if both sets are <see langword="null"/>.
        /// </returns>
        /// <seealso cref="Union(ISet{T}, ISet{T})"/>
        public static ISet<T> operator |(Set<T> setOne, Set<T> anotherSet) {
            return Union(setOne, anotherSet);
        }
        ...
        public virtual ISet<T> Intersect(ISet<T> setOne) {
            ISet<T> resultSet = (ISet<T>)Clone();
            if(setOne != null) {
        ...
        /// </returns>
        public static ISet<T> Intersect(ISet<T> setOne, ISet<T> anotherSet) {
            if(setOne == null && anotherSet == null) {
                return null;
            }
            if(setOne == null) {
        ...
        /// both sets are <see langword="null"/>.
        /// </returns>
        /// <seealso cref="Intersect(ISet{T}, ISet{T})"/>
        public static Set<T> operator &(Set<T> setOne, Set<T> anotherSet) {
            return (Set<T>)Intersect(setOne, anotherSet);
        }
        ...
        public virtual ISet<T> Minus(ISet<T> setOne) {
            ISet<T> resultSet = (ISet<T>)Clone();
            if(setOne != null) {
        ...
        /// <see langword="null"/>.
        /// </returns>
        public static ISet<T> Minus(ISet<T> setOne, ISet<T> anotherSet) {
            if(setOne == null) {
                return null;
            }
        ...
        /// <see langword="null"/>.
        /// </returns>
        /// <seealso cref="Minus(ISet{T}, ISet{T})"/>
        public static Set<T> operator -(Set<T> setOne, Set<T> anotherSet) {
            return (Set<T>)Minus(setOne, anotherSet);
        }
        ...
        public virtual ISet<T> ExclusiveOr(ISet<T> setOne) {
            ISet<T> resultSet = (ISet<T>)Clone();
            foreach(T element in setOne) {
        ...
        /// <see langword="null"/> if both sets are <see langword="null"/>.
        /// </returns>
        public static ISet<T> ExclusiveOr(ISet<T> setOne, ISet<T> anotherSet) {
            if(setOne == null && anotherSet == null) {
                return null;
            }
            if(setOne == null) {
                return (Set<T>)anotherSet.Clone();
            }
            if(anotherSet == null) {
                return (Set<T>)setOne.Clone();
            }
        ...
        /// <see langword="null"/> if both sets are <see langword="null"/>.
        /// </returns>
        /// <seealso cref="ExclusiveOr(ISet{T}, ISet{T})"/>
        public static Set<T> operator ^(Set<T> setOne, Set<T> anotherSet) {
            return (Set<T>)ExclusiveOr(setOne, anotherSet);
        }
        ...
        /// operation.
        /// </returns>
        public abstract bool AddAll(ICollection<T> collection);
        ...
        /// </returns>
        public abstract bool ContainsAll(ICollection<T> collection);
        ...
        /// operation.
        /// </returns>
        public abstract bool RemoveAll(ICollection<T> collection);
        ...
        /// operation.
        /// </returns>
        public abstract bool RetainAll(ICollection<T> collection);
        ...
        public override bool Equals(object obj) {
            Set<T> theOtherSet = obj as Set<T>;
            if(theOtherSet == null)
                return false;

            return Equals(theOtherSet);
        }
