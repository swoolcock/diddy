...
Class BmxTranslator Extends Translator
	...
	Method TransNewObjectExpr$( expr:NewObjectExpr )
		Local t$
		if expr.classDecl.actual.munged<>"Object"
			t="(new "+expr.classDecl.actual.munged+")"
		else
			t="(new "+expr.classDecl.actual.munged+"[0])"
		end
	...
	Method EmitFuncDecl( decl:FuncDecl )
		...
		For Local i=0 Until decl.argDecls.Length
			...
			argCasts.Push "Local "+arg.munged+":"+TransType(arg.ty)+"="+TransType(arg.ty)+Bra(t)
		Next
